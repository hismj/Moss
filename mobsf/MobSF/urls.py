...
from mobsf.StaticAnalyzerByAI.views import (
    static_ai,
    run_model1,
    run_model2,
    url_download,
...
if settings.API_ONLY == '0':
    urlpatterns.extend([
        ...
        re_path(r'^static_ai/$',
                static_ai.static_analyzer_ai,
                name='static_ai'),
        re_path(r'^run_model1/$',
                run_model1.run_model1,
                name='run_model1'),
        re_path(r'^run_model2/$',
                run_model2.run_model2,
                name='run_model2'),
        re_path(r'^url_download/$',
                url_download.download_apk,
                name='url_download'),
        re_path(r'^decode_qr_code/$',
                decode_qr_code.decode_qr_code_view,
                name='decode_qr_code'),
        # Static Analysis
        # Android
