...
# APK文件路径
apk_path = 'data/test/밤친구.apk'
...
with open(csv_file, mode='w', newline='') as file:
    ...
    # 写入表头
    writer.writerow(["android;android.app.cts.permission.TEST_GRANTED;android.intent.category.MASTER_CLEAR.permission"
